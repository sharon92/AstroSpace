...
If you prefer to pin a specific image version instead of `latest`, change the `image:` line in `nginx/docker-compose.yml` to a concrete tag such as `sharonshaji92/astrospace:1.3.3`.
